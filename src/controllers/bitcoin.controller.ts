...
export const getAllTransactions = (
  req: ValidatedRequest<GetTransactionsType>,
  res: Response
) => {
  const { network } = req.query
...
export const sendBitcoin = async (
  ...
  if (
    ...
    return res.json({
      error:
        "Amount has to be greater than 0.000001",
    })
